...
-- V✧RTX.TopBar.ScrollingFrame.UIListLayout
...
-- V✧RTX.TopBar.DropShadowHolder.DropShadow
...
-- V✧RTX.TopBar.TopBar.UIGradient
...
-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.UICorner
DRR["e"] = Instance.new("UICorner", DRR["d"]);
DRR["e"]["CornerRadius"] = UDim.new(0.30000001192092896, 0);

-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.UIGradient
...
-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.ImageLabel
DRR["10"] = Instance.new("ImageLabel", DRR["d"]);
DRR["10"]["BorderSizePixel"] = 0;
DRR["10"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UIAspectRatioConstraint
DRR["11"] = Instance.new("UIAspectRatioConstraint", DRR["10"]);
DRR["11"]["AspectRatio"] = 0.9842342734336853;

-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UICorner
DRR["12"] = Instance.new("UICorner", DRR["10"]);
DRR["12"]["CornerRadius"] = UDim.new(100, 0);

-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.ImageLabel.UIGradient
...
-- V✧RTX.TopBar.ProfileMenu.PlayerProfile.TextLabel
...
-- V✧RTX.TopBar.ProfileMenu.UIListLayout
...
-- V✧RTX.TopBar.ProfileMenu.Clock.TextLabel
...
-- V✧RTX.TopBar.ProfileMenu.Title.TextLabel
...
-- V✧RTX.TopBar.TopBarClose.UICorner
...
-- V✧RTX.TopBar.TopBarClose.idk.UIGradient
...
-- V✧RTX.TopBar.TopBarClose.UIAspectRatioConstraint
DRR["24"] = Instance.new("UIAspectRatioConstraint", DRR["1f"]);


-- V✧RTX.TopBar.TopBarClose.ImageLabel
...
-- V✧RTX.TopBar.TopBarClose.ImageLabel.UIAspectRatioConstraint
DRR["26"] = Instance.new("UIAspectRatioConstraint", DRR["25"]);
DRR["26"]["AspectRatio"] = 0.9836804866790771;

-- V✧RTX.TopBar.UIAspectRatioConstraint
...
-- V✧RTX.MainBar.DropShadowHolder
...
-- V✧RTX.MainBar.DropShadowHolder.DropShadow
...
-- V✧RTX.Folder.TabReserved.UIListLayout
...
-- V✧RTX.Folder.TabButtonReserved
...
-- V✧RTX.Folder.TabButtonReserved.UICorner
...
-- V✧RTX.Folder.TabButtonReserved.Frame.TextLabel
...
-- V✧RTX.Folder.TabButtonReserved.Frame.UIListLayout
...
-- V✧RTX.Folder.TabButtonReserved.UIGradient
DRR["38"] = Instance.new("UIGradient", DRR["33"]);
DRR["38"]["Rotation"] = 90;
DRR["38"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(220, 20, 60)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(220, 20, 60))};

-- V✧RTX.Folder.TabButtonReserved.ImageLabel
DRR["39"] = Instance.new("ImageLabel", DRR["33"]);
DRR["39"]["BorderSizePixel"] = 0;
DRR["39"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.TabButtonReserved.ImageLabel.UIAspectRatioConstraint
DRR["3a"] = Instance.new("UIAspectRatioConstraint", DRR["39"]);
DRR["3a"]["AspectRatio"] = 0.9842342734336853;

-- V✧RTX.Folder.TabButtonReserved.UIListLayout
...
-- V✧RTX.Folder.Dropdown.DropdownBar
DRR["42"] = Instance.new("Frame", DRR["3d"]);
DRR["42"]["BorderSizePixel"] = 0;
DRR["42"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Dropdown.DropdownBar.UICorner
DRR["43"] = Instance.new("UICorner", DRR["42"]);
DRR["43"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- V✧RTX.Folder.Dropdown.DropdownBar.UIGradient
...
-- V✧RTX.Folder.Dropdown.DropdownBar.Trigger
DRR["49"] = Instance.new("TextButton", DRR["42"]);
DRR["49"]["BorderSizePixel"] = 0;
DRR["49"]["AutoButtonColor"] = false;
DRR["49"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Dropdown.Box
DRR["4a"] = Instance.new("Frame", DRR["3d"]);
DRR["4a"]["BorderSizePixel"] = 0;
DRR["4a"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Dropdown.Box.UIGradient
...
-- V✧RTX.Folder.Dropdown.Box.UIStroke
DRR["4c"] = Instance.new("UIStroke", DRR["4a"]);
DRR["4c"]["Color"] = Color3.fromRGB(220, 20, 60);

-- V✧RTX.Folder.Dropdown.Box.UICorner
DRR["4d"] = Instance.new("UICorner", DRR["4a"]);
DRR["4d"]["CornerRadius"] = UDim.new(0.05999999865889549, 0);

-- V✧RTX.Folder.Dropdown.Box.ScrollingFrame
...
DRR["4e"]["MidImage"] = [[]];
DRR["4e"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Dropdown.Box.ScrollingFrame.UIListLayout
...
-- V✧RTX.Folder.Keybind
DRR["50"] = Instance.new("Frame", DRR["30"]);
DRR["50"]["Active"] = true;
DRR["50"]["BorderSizePixel"] = 0;
DRR["50"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Keybind.Description
...
DRR["5e"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Slider.ActualSlider
...
-- V✧RTX.Folder.Slider.ActualSlider.UIStroke
DRR["65"] = Instance.new("UIStroke", DRR["62"]);
DRR["65"]["Color"] = Color3.fromRGB(0, 255, 39);

-- V✧RTX.Folder.Slider.ActualSlider.Fill
...
-- V✧RTX.Folder.Slider.ActualSlider.Fill.UICorner
DRR["67"] = Instance.new("UICorner", DRR["66"]);
DRR["67"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- V✧RTX.Folder.Slider.ActualSlider.Fill.UIGradient
...
-- V✧RTX.Folder.Slider.ActualSlider.Trigger
...
-- V✧RTX.Folder.Slider.ActualSlider.Trigger.UICorner
DRR["6a"] = Instance.new("UICorner", DRR["69"]);
DRR["6a"]["CornerRadius"] = UDim.new(0.20000000298023224, 0);

-- V✧RTX.Folder.Slider.ActualSlider.Trigger.UIGradient
...
-- V✧RTX.Folder.Slider.ActualSlider.Title
...
-- V✧RTX.Folder.Slider.Description
...
-- V✧RTX.Folder.Textbox
DRR["6e"] = Instance.new("Frame", DRR["30"]);
DRR["6e"]["BorderSizePixel"] = 0;
DRR["6e"]["BackgroundColor3"] = Color3.fromRGB(220, 20, 60);
...
-- V✧RTX.Folder.Textbox.Description
...
-- V✧RTX.Folder.Textbox.TextboxBar
...
-- V✧RTX.Folder.Textbox.TextboxBar.UIStroke
DRR["76"] = Instance.new("UIStroke", DRR["73"]);
DRR["76"]["Color"] = Color3.fromRGB(40, 45, 62);

-- V✧RTX.Folder.Textbox.TextboxBar.ActualTextbox
...
-- V✧RTX.Folder.Toggle.Description
...
-- V✧RTX.Folder.Toggle.Label.UIStroke
...
-- V✧RTX.Folder.Toggle.Label.Label
...
-- V✧RTX.Folder.Button.Description
